...
public class MainActivity extends AppCompatActivity implements NoteFragment.OnNoteListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!displayingEditor){
            ...
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.container,EditNote.newInstance(readContent(editingNote)));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_new:
                ...
                ft.replace(R.id.container,EditNote.newInstance(""));
...
//        return super.onOptionsItemSelected(item);
    ...
    public void onNoteSelected(Note note) {
        editingNote = note;
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.container,EditNote.newInstance(readContent(editingNote)),"edit_note");
        ft.addToBackStack(null);
        ft.commit();
        displayingEditor = !displayingEditor;
        invalidateOptionsMenu();
    ...
    public void onBackPressed() {
        EditNote editFragment = (EditNote) getSupportFragmentManager().findFragmentByTag("edit_note");
